...
class BlogPostDAO:
    ...
    def get_post_by_permalink(self, permalink):
        ...
        # 
        # if you store the likes value in the way the template expects and how is implied 
        # by the fixup code below, you don't need to make a change here
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        if (email != ""):
            comment['email'] = email
        try:
            last_error = self.posts.update_one({'permalink': permalink}, 
    ...
    def increment_likes(self, permalink, comment_ordinal):
        ...
        try:
            last_error = self.posts.update_one({'permalink':permalink},{'$inc':{'comments.'+str(comment_ordinal)+'.num_likes':1}}, 
                                            upsert=False)
            return last_error['n']          # return the number of documents updated
