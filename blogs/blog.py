...
# General Discussion on structure. This program implements a blog. This file is the best 
# place to start to get to know the code. In this file, which is the controller, we define a 
# bunch of HTTP routes that are handled by functions. The basic way that this magic occurs
# is through the decorator design pattern. Decorators allow you to modify a function, adding 
# code to be executed before and after the function. As a side effect the bottle.py
...
def post_new_comment():
    ...
    if name == "" or body == "":
        ...
        # it all looks good, insert the comment into the blog post and redirect back
        # to the post viewer
...
def process_login():
    ...
    if user_record:
        ...
        # not getting set on the redirect, you are probably using the experimental 
        # version of bottle (.12). revert to .11 to solve the problem.
...
# Helper Functions
# extracts the tag from the tags form element. an experience python programmer could do 
# this in  fewer lines, no doubt
